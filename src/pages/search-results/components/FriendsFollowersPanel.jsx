...
const FriendsFollowersPanel = () => {
  ...
  const renderUserCard = (userItem, showActions = true) => (
    <div key={userItem?.id} className="bg-card border border-border rounded-lg p-4 hover:shadow-sm transition-shadow">
      ...
      {userItem?.bio && (
        <p className="text-sm text-foreground mb-3 line-clamp-2">{userItem?.bio}</p>
      )}
  ...
  return (
    <div className="bg-card rounded-lg shadow-sm border border-border">
      <div className="p-4 border-b border-border">
        <h2 className="text-lg font-bold text-foreground">Friends & Followers</h2>
      </div>
                ...
                {pendingRequests?.length === 0 && sentRequests?.length === 0 ? (
                  ...
                  <div className="space-y-6">
                    {pendingRequests?.length > 0 && (
                      <div>
                        <h3 className="text-sm font-semibold text-foreground mb-4">Received Requests</h3>
                        <div className="space-y-4">
                          {pendingRequests?.map((request) => (
                            <div key={request?.id} className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                              <div className="flex items-center gap-3 mb-3">
                    ...
                    {sentRequests?.length > 0 && (
                      <div>
                        <h3 className="text-sm font-semibold text-foreground mb-4">Sent Requests</h3>
                        <div className="space-y-4">
